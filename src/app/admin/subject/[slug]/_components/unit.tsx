...
function UnitComponent({
  ...
  const handleTestAdd = (name: string, time: number) => {
    const newT: UnitTest = {
      ...
      questions: [],
      time,
      directions:"Read each passage and question carefully, and then choose the best answer to the question based on the passage(s).  All questions in this section are multiple-choice with four answer choices. Each question has a single best answer."
    };
